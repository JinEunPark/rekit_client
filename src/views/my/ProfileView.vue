    ...
    <AppModal :open="withdrawOpen" title="회원탈퇴" @close="withdrawOpen = false">
      ...
      <div v-else class="withdraw-social">
        ...
        <div class="withdraw-social__btns">
          <button type="button" class="social social--kakao" @click="startSocialReauthWithdraw('kakao')">
            <svg class="social__logo" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path
                fill="#3b1e1e"
          ...
          <button type="button" class="social social--naver" @click="startSocialReauthWithdraw('naver')">
            <svg class="social__logo" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path fill="#fff" d="M16.273 12.845 7.376 0H0v24h7.726V11.156L16.624 24H24V0h-7.727z" />
            </svg>
            네이버로 인증
          </button>
          <button type="button" class="social social--google" @click="startSocialReauthWithdraw('google')">
            <svg class="social__logo" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              <path
                fill="#4285F4"
